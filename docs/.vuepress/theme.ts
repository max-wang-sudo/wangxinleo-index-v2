...
export default hopeTheme({
  ...
  hostname: "https://wangxinleo.cn/",

  author: {
    name: "wangxinleo",
    url: "https://wangxinleo.cn/",
  },
  ...
  repo: "wangxinleo/wangxinleo-index-v2",
  ...
  blog: {
    ...
    description: "前端工程师 | node工程师 | Github爱好者",
    intro: "/intro.html",
    roundAvatar: true,
    medias: {
      GitHub: "https://github.com/wangxinleo",
      // Zhihu: "",
      // '少数派': [
      //   "",
      //   path.resolve(__dirname, "icons/sspai.svg"),
      // ],
      Wechat: "https://x.com/wechat.svg",
      Email: "mailto:wangxin.leo@outlook.com",
